...
public class RequestHandlerSOAServiceLocator extends org.apache.axis.client.Service implements max.RequestHandlerSOAService {
    ...
    private java.lang.String RequestHandlerSOA_address = "http://localhost:8080/SecondWebServiceServerProj/services/RequestHandlerSOA";
    ...
    public max.RequestHandlerSOA getRequestHandlerSOA() throws javax.xml.rpc.ServiceException {
    ...
    public max.RequestHandlerSOA getRequestHandlerSOA(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            max.RequestHandlerSOASoapBindingStub _stub = new max.RequestHandlerSOASoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (max.RequestHandlerSOA.class.isAssignableFrom(serviceEndpointInterface)) {
                max.RequestHandlerSOASoapBindingStub _stub = new max.RequestHandlerSOASoapBindingStub(new java.net.URL(RequestHandlerSOA_address), this);
                _stub.setPortName(getRequestHandlerSOAWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://max", "RequestHandlerSOAService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://max", "RequestHandlerSOA"));
        }
